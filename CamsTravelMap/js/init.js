window.onload=function(){
    ...
    L.marker([64.1466, 21.9426], {icon: redPin}).bindPopup("Traveled: Reykjavik, Iceland").addTo(map);
    L.marker([50.8503, 4.3517], {icon: redPin}).bindPopup("Traveled: Brussels, Belgium").addTo(map);
    L.marker([52.3680, 4.9036], {icon: redPin}).bindPopup("Traveled: Amsterdam, Holland").addTo(map);
